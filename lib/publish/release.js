...
function start() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getMergeConfig()];
                case 1:
                    _a.sent();
                    utils_1.default.logGreen(cwd);
                    return [4 /*yield*/, fileMd5_1.default('./.zip/ios/rn-2.2.0.zip')];
                case 2:
                    filemd5Name = _a.sent();
...
function uploadFile() {
    var name = 'mdludy.zip';
    server_1.uploadServer(name, './.zip/ios/rn-2.2.0.zip', config)
        .then(function (res) {
        utils_1.default.baseLog(res);
    });
}
